<div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="<?php echo base_url('dashboard/aksi_foto') ?>" method="post" enctype="multipart/form-data" novalidate>
                                <div class="row">
                                    <div class="col-md-9 col-sm-9">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="deskripsi" required="required" />
                                        </div>
                                        <div class="">
